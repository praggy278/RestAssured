...
public class DataSerializeAndDeserialize {
	...
	@Test
	public void createJSONfromPOJO() throws JsonProcessingException {
		...
		// Converting a Java class object to a JSON payload as string - Serialization
	...
	@Test
	public void getPOJOFromJSON() throws JsonProcessingException {
		...
		// Converting json string to  class object - Deserialization
